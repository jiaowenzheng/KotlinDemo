...
//        int solid = a.getColor(R.styleable.customTextView_textSolidColor, Color.TRANSPARENT);
     ...
     */
    public void setNormalState(int leftTopRadius, int leftBottomRadius, int rightBottomRadius, int rightTopRadius,
...
//        if (normalGD != null){
//            normalGD.clearColorFilter();
//            normalGD = null;
//        }
//
//        if (pressedGD != null){
//            pressedGD.clearColorFilter();
//            pressedGD = null;
//        }
//
//        if (selector != null){
//            selector.clearColorFilter();
//            selector = null;
//        }
